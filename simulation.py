...
import random
from situations import Action, SituationType, Threat, Ally
...
def start_simulation():
    ...
    main(prob_threat, tLowerSitL, tHigherSitL, tLowerSitDB, tHigherSitDB, tLowerSitNB, tHigherSitNB,
...
def main(prob_threat, tLowerSitL, tHigherSitL, tLowerSitDB, tHigherDB, tLowerSitNB, tHigherSitNB, aLowerSitL, aHigherSitL, aLowerSitDB, aHigherSitDB, aLowerSitNB, aHigherSitNB, Risk_Aversion, Risk_Threshold, MainB, Training_Episodes, LR, Learning_Period):
...
prob_threat_entry.insert(0, "0.5")  # Default value for Probability of Threat

tk.Label(root, text="Threat's Livelihood (Lower Bound)").grid(row=1, column=0)
tLowerSitL_entry = tk.Entry(root)
tLowerSitL_entry.grid(row=1, column=1)
tLowerSitL_entry.insert(0, "80")  # Default value for Threat's Livelihood Lower Bound

tk.Label(root, text="Threat Livelihood (Upper Bound)").grid(row=2, column=0)
tHigherSitL_entry = tk.Entry(root)
tHigherSitL_entry.grid(row=2, column=1)
tHigherSitL_entry.insert(0, "100")  # Default value for Threat Livelihood Upper Bound

tk.Label(root, text="Threat Defensive Belonging (Lower Bound)").grid(row=3, column=0)
tLowerSitDB_entry = tk.Entry(root)
tLowerSitDB_entry.grid(row=3, column=1)
tLowerSitDB_entry.insert(0, "80")  # Default value for Threat Defensive Belonging Lower Bound

tk.Label(root, text="Threat Defensive Belonging (Upper Bound)").grid(row=4, column=0)
tHigherSitDB_entry = tk.Entry(root)
tHigherSitDB_entry.grid(row=4, column=1)
tHigherSitDB_entry.insert(0, "100")  # Default value for Threat Defensive Belonging Upper Bound

tk.Label(root, text="Threat Nurturing Belonging (Lower Bound)").grid(row=5, column=0)
tLowerSitNB_entry = tk.Entry(root)
tLowerSitNB_entry.grid(row=5, column=1)
tLowerSitNB_entry.insert(0, "80")  # Default value for Threat Nurturing Belonging Lower Bound

tk.Label(root, text="Threat Nurturing Belonging (Upper Bound)").grid(row=6, column=0)
tHigherSitNB_entry = tk.Entry(root)
tHigherSitNB_entry.grid(row=6, column=1)
tHigherSitNB_entry.insert(0, "100")  # Default value for Threat Nurturing Belonging Upper Bound

tk.Label(root, text="Ally Livelihood (Lower Bound)").grid(row=7, column=0)
aLowerSitL_entry = tk.Entry(root)
aLowerSitL_entry.grid(row=7, column=1)
aLowerSitL_entry.insert(0, "80")  # Default value for Ally Livelihood Lower Bound

tk.Label(root, text="Ally Livelihood (Upper Bound)").grid(row=8, column=0)
aHigherSitL_entry = tk.Entry(root)
aHigherSitL_entry.grid(row=8, column=1)
aHigherSitL_entry.insert(0, "100")  # Default value for Ally Livelihood Upper Bound

tk.Label(root, text="Ally Defensive Belonging (Lower Bound)").grid(row=9, column=0)
aLowerSitDB_entry = tk.Entry(root)
aLowerSitDB_entry.grid(row=9, column=1)
aLowerSitDB_entry.insert(0, "80")  # Default value for Ally Defensive Belonging Lower Bound

tk.Label(root, text="Ally Defensive Belonging (Upper Bound)").grid(row=10, column=0)
aHigherSitDB_entry = tk.Entry(root)
aHigherSitDB_entry.grid(row=10, column=1)
aHigherSitDB_entry.insert(0, "100")  # Default value for Ally Defensive Belonging Upper Bound

tk.Label(root, text="Ally Nurturing Belonging (Lower Bound)").grid(row=11, column=0)
aLowerSitNB_entry = tk.Entry(root)
aLowerSitNB_entry.grid(row=11, column=1)
aLowerSitNB_entry.insert(0, "80")  # Default value for Ally Nurturing Belonging Lower Bound

tk.Label(root, text="Ally Nurturing Belonging (Upper Bound)").grid(row=12, column=0)
aHigherSitNB_entry = tk.Entry(root)
aHigherSitNB_entry.grid(row=12, column=1)
...
tk.Label(root, text="Risk Aversion (1 is neutral, <1 is inclined to risk, >1 is risk averse)").grid(row=13, column=0)
risk_aversion_entry = tk.Entry(root)
risk_aversion_entry.grid(row=13, column=1)
risk_aversion_entry.insert(0, "1.2")  # Default value for Risk Aversion

tk.Label(root, text="Risk Threshold (How risky an situation is to consider the risk. 10 = normal)").grid(row=14, column=0)
